...
import { getHotArticles, addHotArticles, updateHotArticles, deleteHotArticles } from '../../requests'
...
export default class AddArticle extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Button block className="f_btn" onClick={this.showModal} >添加热门文章</Button>
        <Table columns={this.state.columns} dataSource={this.state.data} rowKey={(record, index) => index} />
        <Modal
          title="添加文章"
          visible={visible}
